...
public class HotelBookingDetails {
    ...
    public HotelBookingDetails(Integer id, String hot_id, String user, String hot_name, String hot_address, String hot_rooms, String hot_price, String hot_CheckIn, String hot_CheckOut) {
        this.id = id;
        Hot_id = hot_id;
        User = user;
